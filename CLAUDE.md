...
│   ├── panel.tsx                 entry; mounts panel/Panel.tsx
│   ├── panel/                    Panel.tsx (root), Transport.tsx (dev transport: presets,
│   │                             play/pause/stop, volume — no EQ; replaced at M3), panel.module.css
